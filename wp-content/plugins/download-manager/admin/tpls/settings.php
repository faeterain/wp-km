...
<div style="clear: both;"></div>
 ...
 <div class="panel panel-default" id="wpdm-wrapper-panel">
     <div class="panel-heading"><button type="submit" class="btn btn-default pull-right" style="font-weight: 600"><i class="sinc fa fa-save color-green"></i> &nbsp; <?php _e("Save Settings","wpdmpro"); ?></button><h3 class="h"><i class="fa fa-cogs color-purple"></i>&nbsp;&nbsp;<?php _e("Download Manager Settings","wpdmpro"); ?></h3>
